    ...
    <main style={{ background: '#F2F4F8', color: '#1A202C', fontFamily: "'Inter', sans-serif", minHeight: '100vh' }}>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; caret-color: transparent; }
        ...
        .sf-cta-btn {
          ...
          background: #ffffff; color: #2e1065; font-weight: 400;
      ...
      <div style={{
        ...
        <span style={{ display: 'flex', alignItems: 'center' }}>
          <img src="https://flagcdn.com/w20/in.png" alt="India" style={{ width: '16px', height: '11px', marginRight: '6px' }} />
              ...
              items={reviews.map((r, i) => ({
                ...
                buttonImage: { 
                  src: i === 0 ? '/uploads/avatar_priya.jpg' : 
                       ...
                       i === 2 ? '/uploads/avatar_kavitha.jpg' :
                       i === 3 ? '/uploads/avatar_neha.jpg' :
                       '/uploads/avatar_aarti.jpg'
                }
              }))}
            />
          </div>
