...
export default function Smooth3DSlideshow(props: Smooth3DSlideshowProps) {
    ...
    // Call onSlideChange when active changes
    useEffect(() => {
        if (onSlideChange) onSlideChange(active)
    ...
    }, [isStatic, autoplay, autoplayDirection, delay, n, step, active]) // Added active to dependencies so interval resets on manual click
